...
def handle_message(event):
    ...
    reply = "請輸入「上限 140」或「目前 108」來使用體力計算功能。"
    ...
    if "上限" in text and "目前" in text:
        ...
        try:
            ...
            reply = "請輸入正確格式，例如：目前108 時間04/27 04:18"
